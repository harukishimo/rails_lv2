...
| 4:00-5:30 | 面談応募・資格反映機能 | 面談応募、評価官割り当て、Slack面談確定通知、合格判定、資格反映をどう開発したか説明する | InterviewApplication、InterviewResult、UserQualification、service、job |
...
| 11:15-12:15 | 外部連携・非同期処理 | Slack送信、retry/mock切替をどう開発したか説明する | StatusChangeEvent、SlackDelivery、job、client |
