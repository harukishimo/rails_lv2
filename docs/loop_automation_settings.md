...
11. 必要なAgentを選ぶ
12. 時間、安全性、依存関係が許す範囲で、複数の `loop:ready` Issueを順に進めてよい
13. IssueごとにLoop Reportを残す
14. 完了したIssueはEvidence Matrixを埋めたPRを作成し、人間確認はPRレビューへ回す
15. 仕様判断や設計判断が必要な場合のみ `human-review` を付けて止める
